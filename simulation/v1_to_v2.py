...
def main():
    ...
    training_instances_filename = '/data/tabletop_dataset/training_shapenet_objects.json'
    test_instances_filename = '/data/tabletop_dataset/test_shapenet_objects.json'
    ...
    views_per_scene = 7
    save_path = '/data/tabletop_dataset_v2/' + \
    ...
    while scene_num < end_scene:
        ...
        sim = suncg_sim.Simulator(mode='gui', 
                                  ...
                                  verbose=False)
        scene_description = json.load(open(save_path.replace('_v2', '_v1') + f"scene_{scene_num:05d}/scene_description.txt"))
